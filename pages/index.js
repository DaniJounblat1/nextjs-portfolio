                        ...
                        <div className="earthDiv" id="earth">
                            <div className="earthElements planetsElements">
                                ...
                                <img
                                    src="/img/earth.gif"
                                    alt="Earth"
                                    className="earthImg2 planetsImgs2"
                                    loading="lazy"
                                />
                                <img
                                    src="/img/earth.gif"
                            ...
                            <div className="satelliteElements planetsElements">
                                ...
                                <img
                                    className="zoom-target satelliteImg2 spaceShipsImgs2"
                        ...
                        <div className="venusDiv" id="venus">
                            <div className="venusElements planetsElements">
                                ...
                                <img
                                    ...
                                    loading="lazy"
                                    alt="Venus"
                                    className="venusImg2 planetsImgs2"
                                />
                                <img
                                    src="/img/venus.gif"
                                    alt="Venus"
                            ...
                            <div className="shuttleElements planetsElements">
                                ...
                                <img
                                    className="zoom-target shuttleImg2 spaceShipsImgs2"
                                    src="/img/shuttle.gif"
                                    alt=""
                                    loading="lazy"
                                />
                        ...
                        <div className="mercuryDiv" id="mercury">
                            <div className="mercuryElements planetsElements">
                                ...
                                <img
                                    src="/img/mercury.gif"
                                    alt="Mercury"
                                    className="mercuryImg2 planetsImgs2"
                                    loading="lazy"
                                />
                                <img
                                    src="/img/mercury.gif"
                            ...
                            <div className="ufoElements planetsElements">
                                ...
                                <img
                                    className="ufoImg2 spaceShipsImgs2"
                                    src="/img/ufo.gif"
                                    alt=""
                                    loading="lazy"
                                />
